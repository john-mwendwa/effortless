		...
		<div class="row">
			<div class="col-md-6 col-sm-6">
				<div class="widget widget_text">
					<a href="index.php" class="logo bottommargin_20">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				<p class="lato small-text">Effortless Insight Africa &copy; copyright 2023 all rights reserved</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="vid-height">
					<iframe id="iframeYoutube" width="560" height="315"  src="https://www.youtube.com/watch?v=3F1sFWYdVQ4" frameborder="0" allowfullscreen></iframe> 
				</div>
			</div>
		</div>
	</div>
